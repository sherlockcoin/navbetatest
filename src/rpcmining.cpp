...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "NavajoAnonBeta/NavajoAnonBeta is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "NavajoAnonBeta/NavajoAnonBeta is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "NavajoAnonBeta/NavajoAnonBeta is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "NavajoAnonBeta/NavajoAnonBeta is downloading blocks...");
