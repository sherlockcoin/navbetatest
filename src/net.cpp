...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("navajoanonbeta-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("navajoanonbeta-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("navajoanonbeta-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NavajoAnonBeta " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
{"navajoanonbeta.no-ip.biz", "navajoanonbeta.no-ip.biz"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("navajoanonbeta-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("navajoanonbeta-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("navajoanonbeta-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("navajoanonbeta-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NavajoAnonBeta is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("navajoanonbeta-start");
